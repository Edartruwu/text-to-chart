...
export const PerformanceBarChart = React.memo(function PerformanceBarChart({
  ...
  const calculateBarSize = React.useCallback(
  ...
  const responsiveValues = React.useMemo((): ResponsiveValues => {
    ...
    containerWidth,
    chartData.length,
    chart.dataKeys.length,
    chart.margin,
    chart.barSize,
    chart.barGap,
    shouldUseVerticalLayout,
  ]); // If custom icon is provided, use it; otherwise determine based on trend
  ...
  const getColorForDataKey = React.useCallback(
  ...
  return (
    <Card
      className={cn(
        "w-full overflow-hidden transition-all duration-200 min-w-[300px]",
        className,
      )}
    >
      {(title || description) && (
      ...
      >
        <div
          ...
          aria-label={
            chart.ariaLabel ||
            `Bar chart showing ${chart.dataKeys.join(", ")} data by ${chart.xAxisKey}`
          }
          ...
          <ChartContainer config={config}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                ...
                maxBarSize={responsiveValues.barSize}
                layout={
                  responsiveValues.isVerticalLayout ? "vertical" : "horizontal"
                }
              ...
              >
                ...
                <XAxis
                  ...
                  type={
                    responsiveValues.isVerticalLayout ? "number" : "category"
                  }
                ...
                <YAxis
                  ...
                  hide={!responsiveValues.isVerticalLayout}
                  type={
                    responsiveValues.isVerticalLayout ? "category" : "number"
                  }
                  tick={{ fontSize: responsiveValues.fontSize }}
                  tickFormatter={
                    responsiveValues.isVerticalLayout
                      ? chart.xAxisFormatter
                      : undefined
                  }
                  minTickGap={5}
                />
                ...
                {chart.showLegend && (
                  <ChartLegend
                    ...
                    verticalAlign={
                      chart.legendPosition === "bottom" ? "bottom" : "top"
                    }
                    align={
                    ...
                    iconSize={
                      breakpoint === "xs" ? 8 : breakpoint === "sm" ? 10 : 14
                    }
                    iconType="circle"
                  />
                )}
